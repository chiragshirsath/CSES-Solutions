...
output : for each query min steps from x to y, or -1 if impossible
intution : functional graph with cycles, find tail length to cycle and use binary lifting
soln : find cycle lengths and tail lengths using dfs, use binary lifting to check if y is reachable from x by comparing their positions relative to cycle entry
*/
#include<bits/stdc++.h>
using namespace std;
